...
const HeaderPageUser = () => {
  ...
  return (
    <div className='container-HeaderPageUser'>
      <div className='block-w-btn-top'>
          <div 
            className='block-w-btn-top__btn-back'
            onClick={() => window.location.pathname = '/cards'}
            >
          ...
          <div 
            className='block-w-btn-top__logout'
            onClick={() => {
      ...
      <div className="block-w">
        ...
        <div className='block-flex'>
          <img src={clientParse.avatar} alt='' />
          <div className='block-w-clientInfo'>
            <h1 className='block-w-info__name'>{clientParse.first_name + ' ' + clientParse.last_name}</h1>
            <p className='block-w-info__description'>Партнер</p>
          </div>
        </div>
        <button 
          onClick={() => {
