...
import { HeaderPageWithCards } from "./Header"
import { CardRow } from "./Card"
import { useEffect } from "react"
import { loadCards } from "../../store/action_creators/cards_action_creator"
import './style.scss'
...
const PageWithCards = () => {
  ...
  return (
    <div className='container-PageWithCards'>
      <HeaderPageWithCards />
      <CardRow cards={cards}/>
      <button className='btn-more' onClick={() => console.log('pagination')}>
        Показать еще
